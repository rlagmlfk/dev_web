...
// void -> ActionForward -> String(spring4.0, 5.0, boot) -> ModelAndView(Object, scope처리:spring2.5까지)
...
// 1-4에서는 가급적 if문을 버리고 메소드로 독립시켜본다(스프링 흉내)
public class ActionServlet extends HttpServlet {
	...
	public void doService(HttpServletRequest req, HttpServletResponse res)
		...
		// 컨텍스트는 톰캣 서버의 server.xml에 배포된 위치 정보값을 참조함
		// /dev_web or /
